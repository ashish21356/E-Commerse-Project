            ...
            <div class="tp-mega-menu-wrapper p-relative">
               <div class="row align-items-center">
                  <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                     <div class="logo">
                        <a href="index.html">
                        <p style="font-size:20px;"><img src="assets_front/img/logo/favicon.png" alt="logo">E-commerce</p>
                        </a>
                     </div>
                  </div>
      ...
      <main>
         ...
         <section class="tp-slider-area p-relative z-index-1">
            <div class="tp-slider-active tp-slider-variation swiper-container">
               ...
               <?php if(!empty($bannner)){
 foreach ($bannner as $bann){
?>
                        ...
                        <div class="row align-items-center">
                           <div class="col-xl-5 col-lg-6 col-md-6">
                              <div class="tp-slider-content p-relative z-index-1">
                                 ...
                                 <h3 class="tp-slider-title">Your one stop solution is here.</h3>
                                 <p>Exclusive offer 
                                    <span>-35% 
                                 ...
                                 <!-- <div class="tp-slider-btn">
                                    <a href="javascript:void(0)" class="tp-btn tp-btn-2 tp-btn-white">Shop Now
                        ...
                        <div class="tab-content" id="myTabContent">
                           <div class="tab-pane fade show active" id="new-tab-pane" role="tabpanel" aria-labelledby="new-tab" tabindex="0">
                              ...
                              <?php if(!empty($products)):
                                 ...
                                 $cat_name= $this->Home_model->cat_name($product->category);
                                 ?>
                                    ...
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       ...
                                       <div class="tp-product-content">
                                          <div class="tp-product-category">
                                             <a href="product/<?=$product->slug?>"><?=$cat_name?></a>
                                          </div>
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price old-price">₹<?=number_format($product->selling_pricce,2)?></span>
                                             <span class="tp-product-price new-price">₹<?=number_format($product->mrp,2)?></span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
