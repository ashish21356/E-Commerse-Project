...
<?php } ?>
                     ...
                     <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                           ...
                           <p>Don’t have an account? <span><a href="Register_ctr">Create a free account</a></span></p>
                        </div>
    ...
    <!-- this is err msg show -->
    <?php if($this->session->flashdata('errsmsg')){ ?>
<div class="alert alert-danger">
<?= $this->session->flashdata('errsmsg')?>
</div>
<?php } ?>
                     </div>
                  </div>
